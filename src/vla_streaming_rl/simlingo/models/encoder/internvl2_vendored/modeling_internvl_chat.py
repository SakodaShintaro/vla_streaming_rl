...
class InternVLChatModel(PreTrainedModel):
    ...
    def __init__(
        ...
        # simlingo-vendor-fix: call post_init() so transformers 5.x has
        # `self.all_tied_weights_keys` and other post-init properties.
        # Upstream skips this, which broke `_finalize_model_loading` with
