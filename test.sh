...
uv run python scripts/train.py exp_name=test debug=true batch_size=2 agent_type=streaming network_class=cot_actor_critic
uv run python scripts/train.py exp_name=test debug=true batch_size=2 agent_type=off_policy network_class=cot_actor_critic
