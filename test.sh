...
uv run python scripts/train.py exp_name=test debug=true batch_size=2 learning_mode=off_policy network_class=animal_actor_critic
uv run python scripts/train.py exp_name=test debug=true batch_size=2 learning_mode=streaming network_class=animal_actor_critic
